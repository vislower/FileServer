...
class FileEncrypterDecrypterIntegrationTest {
    ...
    @Test
    void whenEncryptingFileAndThenDecrypting_thenOriginalFileIsReturned() throws IOException {
    ...
    @Test
    void whenEncryptingFileAndThenDecryptingWithKeyFromKeyStore_thenOriginalFileIsReturned() throws NoSuchAlgorithmException, IOException, KeyStoreException, CertificateException, UnrecoverableKeyException {
        File fileToEncrypt = new File("src/test/resources/java-developers-guide.pdf");
